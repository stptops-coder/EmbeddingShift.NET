...
{
    /// <summary>
    /// Mini End-to-End-Workflow auf Basis von IWorkflow + StatsAwareWorkflowRunner.
    /// Baut auf dem 3-Policies/3-Queries-Szenario auf und liefert map@1 und ndcg@3.
    /// </summary>
    public class MiniEndToEndWorkflowTests
    {
        ...
        {
            var workflow = new MiniSemanticRetrievalWorkflow();
        ...
        /// <summary>
        /// Kleiner, in sich geschlossener Workflow:
        /// - 3 Policies
        /// - 3 Queries
        /// - Keyword-basierte Embeddings
        /// - MAP + nDCG@3 als Metrics
        /// </summary>
        private sealed class MiniSemanticRetrievalWorkflow : IWorkflow
        {
            ...
            public Task<WorkflowResult> RunAsync(IStatsCollector stats, CancellationToken ct = default)
            {
                ...
                var notes = "Mini end-to-end ranking scenario with 3 queries and 3 policies.";
