...
namespace EmbeddingShift.Tests
{
    ...
    public class MiniSystemIntegrationTests
    {
        ...
        public async Task End_to_end_mini_system_runs_core_workflows()
        {
            ...
            Assert.True(prepArtifacts.Metrics.TryGetValue("prep.totalDocs", out var prepDocs));
            Assert.True(prepArtifacts.Metrics.TryGetValue("prep.totalChunks", out var prepChunks));
            ...
            Assert.True(ingestArtifacts.Metrics.TryGetValue("ingest.totalDocs", out var ingestDocs));
            Assert.True(ingestArtifacts.Metrics.TryGetValue("ingest.totalChunks", out var ingestChunks));
            ...
            Assert.True(retrievalArtifacts.Metrics.TryGetValue("map@1", out var map));
            Assert.True(retrievalArtifacts.Metrics.TryGetValue("ndcg@3", out var ndcg));
