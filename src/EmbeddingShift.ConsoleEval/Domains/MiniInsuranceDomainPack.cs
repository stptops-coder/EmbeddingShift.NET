...
internal sealed class MiniInsuranceDomainPack : DomainPackBase
{
    ...
    protected override void PrintDomainHelp(Action<string> log)
    {
        ...
        log("  domain mini-insurance posneg-run [--latest] [--scale=<float>]");
        ...
        log("      EMBEDDINGSHIFT_DATASET_ROOT=<full-or-repo-relative-stage-00-path>");
        log("      EMBEDDINGSHIFT_MINIINSURANCE_DATASET_ROOT=<same-path>  (legacy alias)");
