...
/// <summary>
/// Shared writer for persisted per-query evaluation artifacts. This keeps the artifact shape reusable
/// even when a concrete workflow or domain pack remains specialized.
/// </summary>
internal static class PerQueryArtifactWriter
{
